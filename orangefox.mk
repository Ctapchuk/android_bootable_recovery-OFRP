...
ifeq ($(OF_VANILLA_BUILD),1)
    ...
    OF_DISABLE_EXTRA_SPECIFIC_FEATURES := 1
...
ifeq ($(OF_DISABLE_EXTRA_SPECIFIC_FEATURES),1)
    LOCAL_CFLAGS += -DOF_DISABLE_EXTRA_SPECIFIC_FEATURES='"1"'
    OF_TWRP_COMPATIBILITY_MODE := 1
endif
...
ifeq ($(OF_SUPPORT_ALL_BLOCK_OTA_UPDATES),1)
   ifeq ($(OF_DISABLE_EXTRA_SPECIFIC_FEATURES),1)
        $(warning You cannot use "OF_SUPPORT_ALL_BLOCK_OTA_UPDATES" with "OF_DISABLE_EXTRA_SPECIFIC_FEATURES"/"OF_TWRP_COMPATIBILITY_MODE")
